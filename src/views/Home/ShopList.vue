    ...
    <div class="shop_container">
      <ul v-if="shops.length" class="shop_list">
        ...
        >
          <a>
            <div class="shop_left">
              <img class="shop_img" :src="basePicImg + shop.image_path" />
            </div>
            <div class="shop_right">
              ...
              <section class="shop_rating_order">
                <section class="shop_rating_order_left">
                  <!-- 星星等级评分 -->
                  <!-- :score加冒号 动态绑定属性；:size加冒号 size类型为Number,直接传为String -->
                  <star-score :score="shop.rating" :size="24"></star-score>
...
export default {
  ...
  data() {
    return {
      basePicImg: 'http://cangdu.org:8001/img/'
    }
  }
}
</script>
